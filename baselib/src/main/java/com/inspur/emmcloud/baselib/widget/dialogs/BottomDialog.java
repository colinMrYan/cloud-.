...
//        params.width = (int) (params.width * 0.9);
    ...
    public static class ActionListSheetBuilder {
        ...
        private static ImageView qrCodeImage;
        ...
        public ActionListSheetBuilder setOnActionSheetDlgDismissListener(OnDismissListener listener) {
        ...
        private View buildViews() {
            View wrapperView = View.inflate(mContext, R.layout.basewidget_bottom_actionsheet, null);
            qrCodeImage = wrapperView.findViewById(R.id.iv_qr_code);
...
//            ((TextView) wrapperView.findViewById(R.id.cancel)).setTextColor(cancelColor);
        ...
        public interface OnSheetItemClickListener {
            void onClick(BottomDialog dialog, View itemView, int position);
        }
