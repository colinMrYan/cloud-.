...
import com.inspur.emmcloud.basemodule.media.selector.style.AlbumWindowStyle;
...
public class PictureAlbumAdapter extends RecyclerView.Adapter<PictureAlbumAdapter.ViewHolder> {
    ...
    public List<LocalMediaFolder> getAlbumList() {
        return albumList != null ? albumList : new ArrayList<LocalMediaFolder>();
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final LocalMediaFolder folder = albumList.get(position);
...
//        holder.tvFolderName.setText(context.getString(R.string.ps_camera_roll_num, name, imageNum));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvFolderName, tvSelectTag, tvNumber;
