package com.inspur.emmcloud.basemodule.util.tipsview;
...
public class TipsView extends FrameLayout {
    ...
    public static TipsView init(Context context, FrameLayout rootView) {
        ...
        rootView.addView(tipsView, ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    private void calculate() {
        ...
        float offsetX = (float) (radius * Math.sin(Math.atan((y - startY)
                / (x - startX))));
        float offsetY = (float) (radius * Math.cos(Math.atan((y - startY)
                / (x - startX))));
    ...
    public void attach(final View attachView, final Func<View> copyViewCreator,
        ...
        attachView.setOnTouchListener(new OnTouchListener() {
            protected void init() {
                ...
                startX = attachLocation[0] - thisLocation[0]
                        + attachView.getWidth() / 2;
                startY = attachLocation[1] - thisLocation[1]
                        + attachView.getHeight() / 2;
                ...
                tipImageView.setLayoutParams(new LayoutParams(
                        ViewGroup.LayoutParams.WRAP_CONTENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT));
                ...
                if (listener != null) {
                    parent = getScrollableParent(attachView);
                    if (parent != null) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP
                    ...
                    if (isTrigger) {
                        ...
                        exploredImageView.setX(x - exploredImageView.getWidth()
                                / 2);
                        exploredImageView.setY(y
