...
//    private ColorFilter defaultColorFilter, selectColorFilter, maskWhiteColorFilter;
    private int defaultColorFilter, selectColorFilter, maskWhiteColorFilter;
...
//        maskWhiteColorFilter = StyleUtils.getColorFilter(mContext, R.color.ps_color_half_white);
        defaultColorFilter = mContext.getResources().getColor(R.color.ps_color_20);
        selectColorFilter = mContext.getResources().getColor(R.color.ps_color_80);
        maskWhiteColorFilter = mContext.getResources().getColor(R.color.ps_color_half_white);
