 ...
 */
public class PreferencesByUserAndTanentUtils {


    private PreferencesByUserAndTanentUtils() {
        throw new AssertionError();
    }

    private static String getPreferenceName(Context context) {
        String uid = PreferencesUtils.getString(context, "userID", null);
    ...
    public static boolean clearDataByKey(Context context, String key) {
        SharedPreferences sp = context.getSharedPreferences(getPreferenceName(context), Context.MODE_PRIVATE);
