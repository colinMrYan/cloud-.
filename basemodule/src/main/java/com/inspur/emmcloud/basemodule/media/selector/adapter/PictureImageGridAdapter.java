...
import com.inspur.emmcloud.basemodule.media.selector.adapter.holder.BaseRecyclerMediaHolder;
...
public class PictureImageGridAdapter extends RecyclerView.Adapter<BaseRecyclerMediaHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final BaseRecyclerMediaHolder holder, final int position) {
