...
public class PreviewGalleryAdapter extends RecyclerView.Adapter<PreviewGalleryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        final LocalMedia item = mData.get(position);
...
//                ? R.color.ps_color_half_white : R.color.ps_color_transparent);
        ...
        holder.ivImage.setColorFilter(item.isGalleryEnabledMask() ? holder.ivImage.getContext().getResources().getColor(R.color.ps_color_half_white) : holder.ivImage.getContext().getResources().getColor(R.color.ps_color_transparent));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listener != null) {
                    listener.onItemClick(holder.getAdapterPosition(), item, view);
                }
            }
        });
