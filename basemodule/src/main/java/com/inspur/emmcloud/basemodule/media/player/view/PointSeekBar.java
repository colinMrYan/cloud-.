...
public class PointSeekBar extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        int progressColor = getResources().getColor(R.color.player_default_progress_color);
        int backgroundColor = getResources().getColor(R.color.player_default_progress_background_color);
        if (attrs != null) {
