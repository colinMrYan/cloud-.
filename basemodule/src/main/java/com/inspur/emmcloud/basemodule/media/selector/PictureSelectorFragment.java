...
import com.inspur.emmcloud.basemodule.media.selector.adapter.PictureImageGridAdapter;
import com.inspur.emmcloud.basemodule.media.selector.animators.AlphaInAnimationAdapter;
import com.inspur.emmcloud.basemodule.media.selector.animators.AnimationType;
import com.inspur.emmcloud.basemodule.media.selector.animators.SlideInBottomAnimationAdapter;
import com.inspur.emmcloud.basemodule.media.selector.basic.FragmentInjectManager;
import com.inspur.emmcloud.basemodule.media.selector.basic.IPictureSelectorEvent;
...
import com.inspur.emmcloud.basemodule.media.selector.config.PermissionEvent;
...
import com.inspur.emmcloud.basemodule.media.selector.dialog.AlbumListPopWindow;
...
import com.inspur.emmcloud.basemodule.media.selector.interfaces.OnRecyclerViewPreloadMoreListener;
import com.inspur.emmcloud.basemodule.media.selector.interfaces.OnRecyclerViewScrollListener;
import com.inspur.emmcloud.basemodule.media.selector.interfaces.OnRecyclerViewScrollStateListener;
import com.inspur.emmcloud.basemodule.media.selector.interfaces.OnRequestPermissionListener;
...
import com.inspur.emmcloud.basemodule.media.selector.utils.AnimUtils;
...
import com.inspur.emmcloud.basemodule.media.selector.widget.SlideSelectTouchListener;
import com.inspur.emmcloud.basemodule.media.selector.widget.SlideSelectionHandler;
...
//        if (isCheckReadStorage) {
        ...
        if (PictureSelectionConfig.onPermissionsEventListener != null) {
            ...
            if (isHasCamera) {
                ...
                if (SdkVersionUtils.isR() && config.isAllFilesAccess) {
                    isHasPermissions = Environment.isExternalStorageEmulated();
                } else {
                    isHasPermissions = PermissionChecker.isCheckSelfPermission(getContext(), permissions);
                }
            }
    ...
    private void addRecyclerAction() {
        ...
        if (config.isFastSlidingSelect) {
            final HashSet<Integer> selectedPosition = new HashSet<>();
