...
import com.inspur.emmcloud.volume.util.VolumeFileDownloadCacheUtils;
...
public class VolumeFileTransferAdapter extends RecyclerView.Adapter<VolumeFileTransferAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.volume_app_volume_file_transfer_item_view, null);
...
//                        showVolumeFileDesc(holder, item);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        @BindView(R2.id.volume_file_transfer_item_img)
        ImageView icon;
        @BindView(R2.id.volume_file_transfer_item_name)
        TextView nameTv;
        @BindView(R2.id.volume_file_transfer_item_desc)
        TextView descTv;
        @BindView(R2.id.volume_file_transfer_item_speed)
        TextView speedTv;
        @BindView(R2.id.volume_file_transfer_item_status)
        View statusLayout;
        @BindView(R2.id.volume_file_transfer_item_progressBar)
