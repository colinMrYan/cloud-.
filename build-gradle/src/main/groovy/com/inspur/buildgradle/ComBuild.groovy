package com.inspur.buildgradle

import com.inspur.buildgradle.extern.ComExtension
 ...
 * 功能说明：自动实现组件之间的组装
 *
 * 1、介入编译器自动获取当前编译的module，根据配置文件将module依赖的其他module 以 "compile project"方式写入编译脚本
 * 2、针对主项目app，在编译层级限制其不可被其他模块引用
 * 3、
 */
    ...
    void apply(Project project) {
        ...
        if (isRunAlone) {
            ...
            if (assembleTask.isAssemble && module.equals(compilemodule)) {
                // 编译打包时自动添加依赖module，这一步可以保证开发阶段隔离，编译阶段不隔离
