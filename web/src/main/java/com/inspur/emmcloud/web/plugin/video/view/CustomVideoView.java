...
//                    }
    ...
    public CustomVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.web_CustomVideoView, 0, 0);
        mFitXY = a.getBoolean(R.styleable.web_CustomVideoView_web_video_fitXY, false);
        mAutoRotation = a.getBoolean(R.styleable.web_CustomVideoView_web_video_autoRotation, false);
        a.recycle();
        initVideoView();
    }
