package com.inspur.emmcloud.web.plugin.video.view;
...
public class CustomMediaController extends FrameLayout {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_LOADING: //3
                    show();
                    showCenterView(R.id.video_loading_layout);
                    break;
    ...
    public CustomMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.web_CustomMediaController);
        mScalable = a.getBoolean(R.styleable.web_CustomMediaController_web_video_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.web_video_player_controller, this);
    ...
    private void initControllerView(View v) {
        ...
        loadingLayout = (ViewGroup) v.findViewById(R.id.video_loading_layout);
    ...
    private void showCenterView(int resId) {
        if (resId == R.id.video_loading_layout) {
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.web_video_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.web_video_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);    //center是否同步显示暂停播放
        } else {
            mTurnButton.setImageResource(R.drawable.web_video_player_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
        }
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.web_video_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.drawable.web_video_player_scale_btn);
        }
    }
...
//        super.setEnabled(enabled);
    ...
    public void setFullscreenEnabled(boolean enabled) {     //是否开启全屏
