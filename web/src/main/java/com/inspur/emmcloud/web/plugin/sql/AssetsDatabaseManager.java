...
public class AssetsDatabaseManager {
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        ...
        LogUtils.YfcDebug(String.format("Create database %s", dbfile));
        ...
        if (!flag || !file.exists()) {
            ...
            if (!file.exists() && !file.mkdirs()) {
                LogUtils.YfcDebug("Create \"" + spath + "\" fail!");
                return null;
            }
            if (!copyAssetsToFilesystem(dbfile, sfile)) {
                LogUtils.YfcDebug(String.format("Copy %s to %s fail!", dbfile, sfile));
                return null;
            }
...
//        return String.format(databasepath, context.getApplicationInfo().packageName);
    ...
    private boolean copyAssetsToFilesystem(String assetsSrc, String des) {
        LogUtils.YfcDebug("Copy " + assetsSrc + " to " + des);
     ...
     * @param dbName
     */
    public void deleteDatabace(String dbName) {
        FileUtils.deleteFile(getDatabaseFile(dbName));
    }
}
