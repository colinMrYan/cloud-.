 ...
 */
public class WebWeChatFileManagerFragment extends BaseFragment {
        ...
        fileAdapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int position) {
                ...
                if (fileType == FileType.directory) {
                    ...
                    if (isStatusSelect) {
                        if (maximum == 1) {
                            fileManagerActivity.selectFileBeanList.clear();
                        ...
                        if (fileManagerActivity.selectFileBeanList.contains(file)) {
                            ...
                            if (fileManagerActivity != null) fileManagerActivity.setOKTextStatus();
                            fileAdapter.notifyItemChanged(position);
                            if (fileManagerActivity.fileManagerFragment.currentPath.equals(weChatRootPath)) {
                                fileManagerActivity.fileManagerFragment.fileAdapter.notifyItemChanged(position);
                            }
