...
import com.inspur.emmcloud.webex.ui.adapter.WebexMeetingAdapter;
...
public class WebexMyMeetingActivity extends BaseActivity {
    ...
    private void initView() {
        boolean isFirstEnter = PreferencesUtils.getBoolean(BaseApplication.getInstance(), Constant.PREF_WEBEX_FIRST_ENTER, true);
        ...
        PreferencesUtils.putString(BaseApplication.getInstance(), Constant.PREF_WEBEX_DOWNLOAD_URL, installUri);
    ...
    private void setNoMeetingTipsText() {
        ...
        if (calendar.get(Calendar.YEAR) != Calendar.getInstance().get(Calendar.YEAR)) {
            date = TimeUtils.Calendar2TimeString(calendar, TimeUtils.getFormat(WebexMyMeetingActivity.this, TimeUtils.FORMAT_YEAR_MONTH_DAY));
        } else {
            date = TimeUtils.Calendar2TimeString(calendar, TimeUtils.getFormat(WebexMyMeetingActivity.this, TimeUtils.FORMAT_MONTH_DAY));
        }
        ...
        new CustomDialog.MessageDialogBuilder(WebexMyMeetingActivity.this)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new WebexAppDownloadUtils().showDownloadDialog(WebexMyMeetingActivity.this, downloadUrl);
                    }
                })
                .show();
    }
