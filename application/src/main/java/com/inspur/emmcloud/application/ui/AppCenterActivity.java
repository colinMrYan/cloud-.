...
import com.inspur.emmcloud.application.bean.AppAdsBean;
...
import static com.inspur.emmcloud.application.ui.AppCenterMoreActivity.APP_CENTER_APPLIST;
import static com.inspur.emmcloud.application.ui.AppCenterMoreActivity.APP_CENTER_CATEGORY_NAME;
...
public class AppCenterActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        classListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putSerializable(APP_CENTER_APPLIST, (Serializable) categoryAppList.get(position).getAppItemList());
                bundle.putString(APP_CENTER_CATEGORY_NAME, categoryAppList.get(position).getCategoryName());
    ...
    private void getAllApp() {
        if (NetUtils.isNetworkConnected(getApplicationContext())) {
            ...
            ApplicationAPIService apiService = new ApplicationAPIService(AppCenterActivity.this);
