...
//	private View textBtn;// 贴文字按钮
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mainView = inflater.inflate(R.layout.plugin_fragment_edit_image_main_menu,
				null);
...
//			activity.mTextFragment.getLableTextView().setVisibility(View.VISIBLE);
