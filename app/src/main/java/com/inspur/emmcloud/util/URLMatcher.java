...
//		Pattern pattern = Pattern.compile("(https?://)?\\w+(\\.\\w+)+(/\\S+)?");
		Pattern pattern = Pattern.compile("(\\\\[[^\\\\[\\\\]]+\\\\])\\\\((((https?|ec[cm](-[0-9a-z]+)+|gs-msg)://[a-zA-Z0-9\\\\_\\\\-]+(\\\\.[a-zA-Z0-9\\\\_\\\\-]+)*(\\\\:\\\\d{2,4})?(/?[a-zA-Z0-9\\\\-\\\\_\\\\.\\\\?\\\\=\\\\&\\\\%\\\\#]+)*/?)|([a-zA-Z0-9\\\\-\\\\_]+\\\\.)+([a-zA-Z\\\\-\\\\_]+)(\\\\:\\\\d{2,4})?(/?[a-zA-Z0-9\\\\-\\\\_\\\\.\\\\?\\\\=\\\\&\\\\%\\\\#]+)*/?|\\\\d+(\\\\.\\\\d+){3}(\\\\:\\\\d{2,4})?)\\\\)");
