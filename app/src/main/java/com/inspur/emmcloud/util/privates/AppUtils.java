...
//		imagePicker.setOutPutY(1000); // 保存文件的高度。单位像素
    ...
    public static boolean getIsVoiceWordOpen(){
        return PreferencesByUserAndTanentUtils.getInt(MyApplication.getInstance(), Constant.PREF_APP_OPEN_VOICE_WORD_SWITCH,DisplayMediaVoiceMsg.IS_VOICE_WORD_OPEN) == DisplayMediaVoiceMsg.IS_VOICE_WORD_OPEN;
    }
