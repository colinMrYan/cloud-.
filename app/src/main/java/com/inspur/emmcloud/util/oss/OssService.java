...
public class OssService {
    ...
    public OssService(OSS oss, GetVolumeFileUploadSTSTokenResult getVolumeFileUploadSTSTokenResult, UIDisplayer UIDisplayer) {
        this.oss = oss;
        this.getVolumeFileUploadSTSTokenResult = getVolumeFileUploadSTSTokenResult;
        this.UIDisplayer = UIDisplayer;
        this.multiPartUploadManager = new MultiPartUploadManager(oss, getVolumeFileUploadSTSTokenResult.getBucket(), partSize, UIDisplayer);
    }
    ...
    public void asyncGetImage(String object) {
        ...
        GetObjectRequest get = new GetObjectRequest(getVolumeFileUploadSTSTokenResult.getBucket(), object);
...
//                    UIDisplayer.displayInfo("Bucket: " + getVolumeFileUploadSTSTokenResult.getBucket() + "\nObject: " + request.getObjectKey() + "\nRequestId: " + result.getRequestId());
//                }
//                catch (IOException e) {
//                    e.printStackTrace();
//                }
...
//                UIDisplayer.displayInfo(info);
    ...
    public PauseableUploadTask asyncMultiPartUpload(GetVolumeFileUploadSTSTokenResult getVolumeFileUploadSTSTokenResult, String localFile) {
        if (getVolumeFileUploadSTSTokenResult.getFileName().equals("")) {
        ...
        PauseableUploadTask task = multiPartUploadManager.asyncUpload(getVolumeFileUploadSTSTokenResult, localFile);
        return task;
    }
