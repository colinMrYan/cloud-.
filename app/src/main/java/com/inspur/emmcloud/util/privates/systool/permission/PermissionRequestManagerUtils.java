package com.inspur.emmcloud.util.privates.systool.permission;
...
import com.inspur.emmcloud.util.privates.systool.emmpermission.EmmPermission;
import com.inspur.emmcloud.util.privates.systool.emmpermission.EmmPermissionBase;
import com.inspur.emmcloud.util.privates.systool.emmpermission.EmmPermissionListener;
...
public class PermissionRequestManagerUtils {
    ...
    private void exitByPermission(List<String> permissionList) {
        if (!(PermissionRequestManagerUtils.getInstance().isHasPermission(MyApplication.getInstance(), Permissions.STORAGE)
                && PermissionRequestManagerUtils.getInstance().isHasPermission(MyApplication.getInstance(), Permissions.READ_PHONE_STATE))) {
            if (callback != null) {
