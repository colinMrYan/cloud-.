...
/**
 * Created by chenmch on 2019/9/6.
 */

public class MyAmazonS3Client extends AmazonWebServiceClient implements AmazonS3 {
     ...
     */
    @Deprecated
    public MyAmazonS3Client(AWSCredentials awsCredentials) {
     ...
     */
    @Deprecated
    public MyAmazonS3Client(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    @Deprecated
    public MyAmazonS3Client(AWSCredentialsProvider credentialsProvider) {
     ...
     */
    @Deprecated
    public MyAmazonS3Client(ClientConfiguration clientConfiguration) {
     ...
     * @param region                 the AWS region
     */
    public MyAmazonS3Client(AWSCredentialsProvider awsCredentialsProvider,
                            com.amazonaws.regions.Region region) {
     ...
     * @see AmazonS3Client#region(AWSCredentials, ClientConfiguration, com.amazonaws.regions.Region)
     */
    public MyAmazonS3Client(ClientConfiguration clientConfiguration,
                            com.amazonaws.regions.Region region) {
    ...
    public S3Object getObject(GetObjectRequest getObjectRequest)
        ...
        try {
            ...
            if (progressListenerCallbackExecutor != null) {
                @SuppressWarnings("resource") final ProgressReportingInputStream progressReportingInputStream = new ProgressReportingInputStream(
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest)
        ...
        if (contentLength == null) {
            ...
            if (expectedLength >= 0) {
                ...
                @SuppressWarnings("resource") final LengthCheckInputStream lcis = new LengthCheckInputStream(
                        input,
    ...
    public CopyObjectResult copyObject(CopyObjectRequest copyObjectRequest)
        ...
        try {
            @SuppressWarnings("unchecked") final ResponseHeaderHandlerChain<CopyObjectResultHandler> handler = new ResponseHeaderHandlerChain<CopyObjectResultHandler>(
    ...
    public DeleteObjectsResult deleteObjects(DeleteObjectsRequest deleteObjectsRequest) {
        ...
        @SuppressWarnings("unchecked") final ResponseHeaderHandlerChain<DeleteObjectsResponse> responseHandler = new ResponseHeaderHandlerChain<DeleteObjectsResponse>(
    ...
    public CompleteMultipartUploadResult completeMultipartUpload(
        ...
        do {
            ...
            @SuppressWarnings("unchecked") final ResponseHeaderHandlerChain<CompleteMultipartUploadHandler> responseHandler = new ResponseHeaderHandlerChain<CompleteMultipartUploadHandler>(
                    // xml payload unmarshaller
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(
        ...
        @SuppressWarnings("unchecked") final ResponseHeaderHandlerChain<InitiateMultipartUploadResult> responseHandler = new ResponseHeaderHandlerChain<InitiateMultipartUploadResult>(
                // xml payload unmarshaller
     ...
     *
     * @param bucketName      The name of the bucket containing the specified key, or if no
...
//                    + endpoint.getAuthority());
     ...
     *
     * @param request    The request to add the partNumber to.
     * @param partNumber The part number to be added.
     */
