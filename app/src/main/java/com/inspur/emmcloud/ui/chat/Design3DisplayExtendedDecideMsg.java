...
public class Design3DisplayExtendedDecideMsg {
    ...
    public static View getView(Message msg, final Context context) {
        View convertView = LayoutInflater.from(context).inflate(R.layout.design3_chat_msg_card_child_extended_decide_view, null);
