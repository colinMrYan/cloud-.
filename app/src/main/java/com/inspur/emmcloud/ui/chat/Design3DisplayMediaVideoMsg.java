 ...
 * @author 视频卡片
 */
public class Design3DisplayMediaVideoMsg {
    /**
     * 展示视频资源卡片
     *
     * @param context
    ...
    public static View getView(final Activity context, final UIMessage uiMessage) {
        ...
        View cardContentView = LayoutInflater.from(context).inflate(R.layout.design3_chat_msg_card_child_res_video_view, null);
