 ...
 * Description
 */
public class ConversationSendMultiHeadAdapter extends BaseAdapter {

    private Context context;
    private List<MessageForwardMultiBean> conversationList;

    public ConversationSendMultiHeadAdapter(Context context, List<MessageForwardMultiBean> conversationList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = View.inflate(context, R.layout.conversation_send_multi_head_item, null);
