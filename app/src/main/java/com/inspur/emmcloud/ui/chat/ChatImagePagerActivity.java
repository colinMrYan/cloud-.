 ...
 * 图片查看器
 */
public class ChatImagePagerActivity extends BaseFragmentActivity {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.enter_channel_imgs_img:
                ...
                IntentUtils.startActivity(ChatImagePagerActivity.this,
            ...
            case R.id.comment_count_text:
                ...
                Intent intent = new Intent(ChatImagePagerActivity.this, ChannelMsgDetailActivity.class);
