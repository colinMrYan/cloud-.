...
public class FaceSettingActivity extends BaseActivity {
    ...
    protected void onResume() {
        super.onResume();
        openFaceVertifyBtn.setChecked(FaceVerifyActivity.getFaceVerifyIsOpenByUser(MyApplication.getInstance()));
        faceRelativeLayout.setVisibility(FaceVerifyActivity.getFaceVerifyIsOpenByUser(MyApplication.getInstance()) ? View.VISIBLE : View.GONE);
    }
