...
//                if (msgList.size() > 0 && MsgCacheUtil.isDataInLocal(MyApplication.getInstance(), cid, msgList
//                        .get(0).getMid(), 15)) {
//                    List<Msg> historyMsgList = MsgCacheUtil.getHistoryMsgList(
//                            ChannelRobotActivity.this, cid, msgList.get(0).getMid(),
//                            15);
...
//                            Message pushMsg;
//                            if (obj.has("message")){
//                                pushMsg= new Message(obj) ;
//                            }else {
//                                pushMsg= new Message(obj,true) ;
//                            }
...
//        Message localMsg = ConbineMsg.conbineTextPlainMsgRobot(content,
//                cid, fakeMessageId);
...
//                Message replContactCardMsg = ConbineMsg.conbineReplyAttachmentCardMsg(contact, cid, robotUid, fakeMessageId);
...
//     * @param msg
//     */
//    private void addLocalMessage(Message msg, int status) {
//        if (msg != null) {
//            //本地添加的消息设置为正在发送状态
...
//                        .getNewMsgList(cid);
//                MsgCacheUtil.saveMsgList(MyApplication.getInstance(), historyMsgList,
...
////
////        @Override
////        public void returnUpLoadResFileFail(String error, int errorCode) {
////            WebServiceMiddleUtils.hand(ChannelRobotActivity.this, error, errorCode);
////        }
//
//        @Override
