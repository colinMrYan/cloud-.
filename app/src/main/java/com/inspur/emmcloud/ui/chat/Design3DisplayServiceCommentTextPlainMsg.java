...
public class Design3DisplayServiceCommentTextPlainMsg {
    ...
    public static View getView(final Activity context, final Message message) {
        View cardContentView = LayoutInflater.from(context).inflate(
                R.layout.design3_chat_msg_card_service_child_text_comment_view, null);
...
//                isMyMsg ? R.color.white : ResourceUtils.getResValueOfAttr(context, R.attr.text_color_e1)));
        dividerView.setBackgroundColor(context.getResources().getColor(
                isMyMsg ? ResourceUtils.getResValueOfAttr(context, R.attr.design3_color_ne05) : ResourceUtils.getResValueOfAttr(context, R.attr.design3_color_ne07)));
        ...
        TransHtmlToTextUtils.stripUnderlines(
                commentContentText, context.getResources().getColor(R.color.color_te07));
