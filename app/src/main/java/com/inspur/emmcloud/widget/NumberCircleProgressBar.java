    ...
    public NumberCircleProgressBar(Context context, AttributeSet attrs,
        ...
        try {
            mFillMode = attributes.getInt(
                    R.styleable.NumberCircleProgressBar_cirprogress_fill_mode,
                    DEFAULT_FILL_MODE);
            mCircleRadius = attributes.getDimension(
                    R.styleable.NumberCircleProgressBar_cirprogress_circle_radius,
                    DEFAULT_CIRCLE_RADIUS);

            mReachedBarColor = attributes.getColor(
                    R.styleable.NumberCircleProgressBar_cirprogress_reached_color,
                    DEFAULT_REACHED_COLOR);
            mUnreachedBarColor = attributes
                    .getColor(
                            R.styleable.NumberCircleProgressBar_cirprogress_unreached_color,
                            DEFAULT_UNREACHED_COLOR);
            mTextColor = attributes.getColor(
                    R.styleable.NumberCircleProgressBar_cirprogress_text_color,
                    DEFAULT_TEXT_COLOR);
            mTextSize = attributes.getDimension(
                    R.styleable.NumberCircleProgressBar_cirprogress_text_size,
                    DEFAULT_TEXT_SIZE);

            int textVisible = attributes
                    .getInt(R.styleable.NumberCircleProgressBar_cirprogress_text_visibility,
