...
import com.inspur.emmcloud.basemodule.media.selector.demo.PhotoMainActivity;
...
//                            AppUtils.openGallery((Activity) getContext(), 5, GELLARY_RESULT, true);
    ...
    private void openGallery() {
        ...
        numberSelectMainStyle.setSelectNormalText(getResources().getString(R.string.ps_send));
        ...
        numberSelectMainStyle.setPreviewSelectText(getResources().getString(R.string.ps_select));
        ...
        numberSelectMainStyle.setSelectText(getResources().getString(R.string.ps_send_num));
        ...
        numberBottomNavBarStyle.setBottomPreviewNormalText(getResources().getString(R.string.ps_preview));
        ...
        numberBottomNavBarStyle.setBottomPreviewSelectText(getResources().getString(R.string.ps_preview_num));
