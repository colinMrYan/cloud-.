...
public class CircleFrameLayout extends FrameLayout {
    ...
    public CircleFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            float radius = ta.getDimension(R.styleable.CircleFrameLayout_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.CircleFrameLayout_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.CircleFrameLayout_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.CircleFrameLayout_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.CircleFrameLayout_bottomRightRadius, radius);
            ta.recycle();
        }
