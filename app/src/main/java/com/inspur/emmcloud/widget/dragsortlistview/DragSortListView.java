...
public class DragSortListView extends ListView {
    ...
    /**
     * Determines the startWebSocket of the upward drag-scroll region at the top of the
     * ListView. Specified by a fraction of the ListView height, thus screen
     * resolution agnostic.
     */
    private float mDragUpScrollStartFrac = 1.0f / 3.0f;
    /**
     * Determines the startWebSocket of the downward drag-scroll region at the bottom of
...
//
    ...
    private static int buildRunList(SparseBooleanArray cip, int rangeStart,
        ...
        if (currentRunEnd == rangeEnd) {
            ...
            // checking if the startWebSocket equals the end position.
     ...
     * ListView height.
     *
     * @param upperFrac Fraction of ListView height for up-scroll bound. Capped at
     *                  0.5f.
     * @param lowerFrac Fraction of ListView height for down-scroll bound. Capped at
     *                  0.5f.
     */
    ...
    private void continueDrag(int x, int y) {
        ...
        if (minY > mLastY && minY > mDownScrollStartY
            ...
            // dragged down, it is below the down scroll startWebSocket and it is not
            // scrolling up
     ...
     * @param dragFlags Flags that restrict some movements of the floating View. For
     ...
     * @param deltaX    Offset in x of the touch coordinate from the left edge of the
     *                  floating View (i.e. touch-x minus float View left).
     * @param deltaY    Offset in y of the touch coordinate from the top edge of the
     ...
     * ListView. If enabled, items are draggable, where the drag startWebSocket mode
    ...
    public void moveCheckState(int from, int to) {
        ...
        // startWebSocket and end of the "runs" of checked items, and then moving the
    ...
    public interface DragScrollProfile {
         ...
         * @param t Time (in milliseconds) since startWebSocket of scroll (handy if you
