...
//                      + "---" + ev.getRawY() + "----" + ev.getY()+"-----"+item.getTop());  
                    ...
                    View dragger = item.findViewById(R.id.my_common_office_handle);//拖动的ImageView
                    Rect r = mTempRect;
                    // dragger.getDrawingRect(r);

                    LogUtils.debug("yfcLog", "daagger:" + dragger.getVisibility() + dragger.getId());
                    r.left = dragger.getLeft();
                    r.right = dragger.getRight();
                    r.top = dragger.getTop();
                    r.bottom = dragger.getBottom();

                    LogUtils.debug("yfcLog", "left:" + dragger.getLeft());
                    LogUtils.debug("yfcLog", "right:" + dragger.getRight());
                    LogUtils.debug("yfcLog", "top:" + dragger.getLeft());
                    LogUtils.debug("yfcLog", "bottom:" + dragger.getBottom());
                    ...
                    //
                    View delView = item.findViewById(R.id.my_common_office_selected_img);//删除的ImageView
