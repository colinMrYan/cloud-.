package com.inspur.emmcloud.widget.tag;
...
public class MyFlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet,
                R.styleable.MyFlowLayout);
        try {
            horizontalSpacing = a.getDimensionPixelSize(
                    R.styleable.MyFlowLayout_horizontalSpacing, 0);
            verticalSpacing = a.getDimensionPixelSize(
                    R.styleable.MyFlowLayout_verticalSpacing, 0);
            orientation = a.getInteger(R.styleable.MyFlowLayout_orientation,
                    HORIZONTAL);
            debugDraw = a.getBoolean(R.styleable.MyFlowLayout_debugDraw, false);
        } finally {
            a.recycle();
        }
    }
