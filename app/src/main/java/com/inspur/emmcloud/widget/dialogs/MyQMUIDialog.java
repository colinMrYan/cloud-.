...
/**
 * MyQMUIDialog 对话框一般由 {@link QMUIDialogBuilder} 及其子类创建, 不同的 Builder 可以创建不同类型的对话框,
 * 例如消息类型的对话框、菜单项对话框等等。
 *
 * @author cginechen
 * @date 2015-10-20
 ...
 */
public class MyQMUIDialog extends Dialog {
    ...
    public static class MessageDialogBuilder extends QMUIDialogBuilder<MessageDialogBuilder> {
        ...
        public MessageDialogBuilder(Context context) {
            ...
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_dialog_content_message_text_size));
        }
    ...
    public static class CheckBoxMessageDialogBuilder extends QMUIDialogBuilder<CheckBoxMessageDialogBuilder> {
        ...
        public CheckBoxMessageDialogBuilder(Context context) {
            super(context);
            mCheckMarkDrawable = QMUIResHelper.getAttrDrawable(context, com.qmuiteam.qmui.R.attr.qmui_s_checkbox);

            mTextView = new TextView(mContext);
            mTextView.setTextColor(QMUIResHelper.getAttrColor(mContext, com.qmuiteam.qmui.R.attr.qmui_config_color_gray_4));
            mTextView.setLineSpacing(QMUIDisplayHelper.dpToPx(2), 1.0f);
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_dialog_content_message_text_size));
        }
        ...
        protected void onCreateContent(com.qmuiteam.qmui.widget.dialog.QMUIDialog dialog, ViewGroup parent) {
            if (mMessage != null && mMessage.length() != 0) {
                ...
                mTextView.setPadding(
                        QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getAttrDimen(mContext, hasTitle() ? com.qmuiteam.qmui.R.attr.qmui_dialog_confirm_content_padding_top : com.qmuiteam.qmui.R.attr.qmui_dialog_content_padding_top_when_no_title),
                        QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getAttrDimen(mContext, com.qmuiteam.qmui.R.attr.qmui_dialog_confirm_content_padding_bottom)
                );
    ...
    public static abstract class AutoResizeDialogBuilder extends QMUIDialogBuilder {
        ...
        public abstract View onBuildContent(com.qmuiteam.qmui.widget.dialog.QMUIDialog dialog, ScrollView parent);
