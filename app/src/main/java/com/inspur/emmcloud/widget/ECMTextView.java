...
/**
 * classes : com.inspur.emmcloud.widget.StartCustomTextView
 * Create at 2016年12月9日 上午11:20:00
 */
public class ECMTextView extends TextView {
    ...
    public ECMTextView(Context context, AttributeSet set) {
        super(context, set);
...
//        canvas.setViewport(m_iTextWidth, m_iTextWidth);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LayoutParams layout = new LayoutParams(measuredWidth, measuredHeight);
