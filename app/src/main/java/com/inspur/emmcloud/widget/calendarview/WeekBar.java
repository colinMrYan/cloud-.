...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.inspur.emmcloud.widget.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.inspur.emmcloud.widget.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
