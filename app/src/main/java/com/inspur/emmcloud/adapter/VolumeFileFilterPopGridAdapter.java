...
public class VolumeFileFilterPopGridAdapter extends BaseAdapter {
    ...
    private int[] filterTypeIconIds = {R.drawable.baselib_file_type_document, R.drawable.baselib_file_type_img, R.drawable.baselib_file_type_audio, R.drawable.baselib_file_type_video, R.drawable.baselib_file_type_more};
