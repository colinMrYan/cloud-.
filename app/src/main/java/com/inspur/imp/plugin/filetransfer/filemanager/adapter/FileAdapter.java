package com.inspur.imp.plugin.filetransfer.filemanager.adapter;
...
public class FileAdapter extends RecyclerViewAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view = mLayoutInflater.inflate(R.layout.plugin_filemanager_list_item_file, parent, false);
    ...
    public void onBindViewHolders(RecyclerView.ViewHolder holder, int position) {
        ...
        if (fileType == FileType.directory) {
            ...
            fileHolder.dir_enter_image.setImageResource(isSelected?R.drawable.ic_volume_file_selct_yes:R.drawable.ic_volume_file_selct_no);
        }
