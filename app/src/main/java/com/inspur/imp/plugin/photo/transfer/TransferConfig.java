package com.inspur.imp.plugin.photo.transfer;
...
import com.inspur.imp.plugin.photo.loader.ImageLoaderCommon;
import com.inspur.imp.plugin.photo.style.IIndexIndicator;
import com.inspur.imp.plugin.photo.style.IProgressIndicator;
...
public final class TransferConfig {
    ...
    public void setImageLoader(ImageLoaderCommon imageLoader) {
...
//    }
    ...
    //    private Transferee.OnTransfereeLongClickListener longClickListener;
         ...
         */
        public Builder setImageLoader(ImageLoaderCommon imageLoader) {
            this.imageLoader = imageLoader;
            return this;
        }
