...
import com.inspur.imp.plugin.camera.zoom.PhotoView;
import com.inspur.imp.plugin.camera.zoom.ViewPagerFixed;
	...
	private class DelListener implements OnClickListener {
		...
		public void onClick(View v) {
			if (listViews.size() == 1) {
				...
				send_bt.setText(Res.getString("finish")+"(" + Bimp.selectBitmap.size() + "/"+ CameraService.num+")");
...
//                sendBroadcast(intent);
				...
				Bimp.selectBitmap.remove(location);
