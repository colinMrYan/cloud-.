...
import com.inspur.imp.plugin.camera.editimage.model.RatioItem;
import com.inspur.imp.plugin.camera.editimage.utils.BitmapUtils;
import com.inspur.imp.plugin.camera.editimage.utils.Matrix3;
...
public class CropFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mainView = inflater.inflate(R.layout.plugin_fragment_edit_image_crop, null);
	...
	private final class CropImageTask extends AsyncTask<Bitmap, Void, Bitmap> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = EditImageActivity.getLoadingDialog(getActivity(), "图片生成中...",
					false);
			dialog.show();
		}
